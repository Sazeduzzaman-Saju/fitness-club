...
const Question = () => {
    return (
        <div className='container mt-5 mb-5  d-flex flex-column justify-content-center align-items-center'>
            <h1 className='mt-5  faq-title'>Some Question</h1>
            <p className='mb-5'>Check List Of Last Module</p>
            <div className="accordion  w-50" id="accordionPanelsStayOpenExample">
